...
<div ng-app="subscriptionApp" ng-controller="subscriptionCtrl">
	<div class="row">
		...
		<div class="alert alert-warning" ng-show="<?= !$subscription->payed ?>">We hebben uw betaling nog niet ontvangen. Indien u reeds heeft betaald zal u binnenkort een bevestigingsmail ontvangen.
